...
Scenario: Assign some actions to a goal
    Given I have entered "Create a new shortlist of lower priced vendors for office consumables" and assigned it to the "Lower costs by 10%" goal as the first action
